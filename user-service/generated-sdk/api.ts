...
export const UserManagementApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async logoutUser(logoutUserRequest: LogoutUserRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LogoutUser200Response>> {
...
export const UserManagementApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        logoutUser(logoutUserRequest: LogoutUserRequest, options?: RawAxiosRequestConfig): AxiosPromise<LogoutUser200Response> {
...
export class UserManagementApi extends BaseAPI {
    ...
    public logoutUser(logoutUserRequest: LogoutUserRequest, options?: RawAxiosRequestConfig) {
        return UserManagementApiFp(this.configuration).logoutUser(logoutUserRequest, options).then((request) => request(this.axios, this.basePath));
    }
